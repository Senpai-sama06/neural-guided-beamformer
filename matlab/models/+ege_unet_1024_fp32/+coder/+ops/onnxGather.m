...
% Copyright 2024 The MathWorks, Inc.
    ...
    X          = ege_unet_1024_fp32.coder.ops.extractIfDlarray(X_);
    ONNXIdx    = ege_unet_1024_fp32.coder.ops.extractIfDlarray(ONNXIdx_);
    ONNXAxis   = ege_unet_1024_fp32.coder.ops.extractIfDlarray(ONNXAxis_);
    numDimsX   = ege_unet_1024_fp32.coder.ops.extractIfDlarray(numDimsX_);
    numDimsIdx = ege_unet_1024_fp32.coder.ops.extractIfDlarray(numDimsIdx_);
