...
Starts = ege_unet_1024_fp32.coder.ops.extractIfDlarray(Starts_);
Ends = ege_unet_1024_fp32.coder.ops.extractIfDlarray(Ends_);
Axes_ = ege_unet_1024_fp32.coder.ops.extractIfDlarray(Axes__);
Steps_ = ege_unet_1024_fp32.coder.ops.extractIfDlarray(Steps__);
